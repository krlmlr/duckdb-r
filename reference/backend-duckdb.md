...
#> ℹ Using SQL: SELECT * FROM (FROM '/tmp/Rtmpe8KPD2/file52d75a8ed522.csv') q01
#>   WHERE (0 = 1)
#> Caused by error in `dbSendQuery()`:
#> ! IO Error: No files found that match the pattern "/tmp/Rtmpe8KPD2/file52d75a8ed522.csv"
...
#>   read_csv_auto('/tmp/Rtmpe8KPD2/file52d75a8ed522.csv')) q02 WHERE (0 = 1)
#> Caused by error in `dbSendQuery()`:
#> ! IO Error: No files found that match the pattern "/tmp/Rtmpe8KPD2/file52d75a8ed522.csv"
#> 
#> LINE 2: FROM (FROM read_csv_auto('/tmp/Rtmpe8KPD2/file52d75a8ed522.csv')) q02
#>                    ^
#> ℹ Context: rapi_prepare
#> ℹ Error type: IO
db_csv %>%
