# test_all_types() output
    ...
    Code
      bad <- c("timestamp_tz", "time_tz", "timestamp_ns", "timestamp_tz_ns",
        "timestamp_array", "timestamptz_array", "bit", "\"union\"",
        "fixed_nested_int_array", "fixed_nested_varchar_array", "fixed_struct_array",
        "fixed_array_of_int_list", "bignum", "time_ns", "geometry", NULL)
